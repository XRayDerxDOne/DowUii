...
ImageButton.Image = "http://www.roblox.com/asset/?id=17773146415"
...
do
	local ui = game.CoreGui:FindFirstChild("XSea")
	if ui then
		ui:Destroy()
	end
end
local logo = getgenv().Logo 
if logo == nil then logo = 17773146415 end
